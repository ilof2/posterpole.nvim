...
function M.setup(palette, config)
  ...
  return {
    ...
    EndOfBuffer = { bg = config.colorless_bg and palette.bgColorless or palette.bg, fg = colors.gray2 },
    ...
    Operator = { fg = colors.gray3 },                 -- '+', '*', 'sizeof' etc
    ...
    DiffChange = { bg = colors.brightGreen1 },
    DiagnosticError = { fg = colors.deepRed2 },
